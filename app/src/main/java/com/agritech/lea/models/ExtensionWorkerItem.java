...
public class ExtensionWorkerItem {

    private String id, name, location, chemicals, phone;

    public ExtensionWorkerItem() {
    }

    public ExtensionWorkerItem(String id, String name, String location, String chemicals, String phone) {
        super();
        this.id = id;
        this.name = name;
